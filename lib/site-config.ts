export const siteConfig = {
  ...
  hero: {
    ...
    subtitle:
      "Exchange your segregated waste at smart collection booths for ZenDollar tokens. Redeem eco-friendly rewards while we turn your waste into clean Bio-CNG.",
    trustRow: ["Blockchain Verified", "Carbon Neutral", "Bangalore, India"],
  },
  ecosystem: {
